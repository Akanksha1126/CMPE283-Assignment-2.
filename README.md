...
- We can Login to the launched instance using two methods
    ...
    ![](screenshots/ssh_login_akanksha.png)
...
- Created usermode program [test_assignment1.c](./test_assignment2.c) on Launched VM
- compile the c program using `gcc -o test_assignment1 test_assignment1.c`
- execute the program using compiled code `./test_assignment1` on launched VM
- execute the program using compiled code `./test_assignment1`
